 ...
 *
 * @param[in] num_consumers Size of @a consumers. If @a consumers is NULL, this
 * argument is ignored.
 *
 * @param[in] consumers List of agents that might consume (wait on) the
 * signal. Might be NULL.
 *
 ...
 * the resources required by the implementation.
 *
 * @retval ::HSA_STATUS_ERROR_INVALID_ARGUMENT If @a signal is NULL.
 */
