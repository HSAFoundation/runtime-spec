...
\fancyfoot[LO,RE]{\scriptsize{HSA Runtime Programming Guide and API Reference}}
...
\subsection{Example}
The following sample code below shows how multiple threads can safely add
packets to a queue.
...
\hypertarget{coredebug}{}\section{Execution Control}\label{coredebug}
