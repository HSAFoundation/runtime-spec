...
(\hsaref{HSA_EXECUTABLE_SYMBOL_INFO_KERNEL_DYNAMIC_CALLSTACK}) if a dynamic call
stack is used.
...
usage of a kernel dispatch packet (the amount of memory used by all the
work-items) must not exceed the value of \hsaref{HSA_REGION_INFO_ALLOC_MAX_SIZE}
...
\end{longtable}
\vspace{-2mm}\noindent\textbf{Description}\\
Every global/readonly variable that is external must be defined before loading the code object. Internal global/readonly variable is allocated once the code object, that is being loaded, references this variable and this variable is not allocated.\\[2mm]
...
\refarg{address}\\\hspace{2em}(in) Address where the variable is defined. This address must be in global memory and can be read and written by any agent in the system. The application cannot deallocate the buffer pointed by \textit{address} before \textit{executable} is destroyed.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\refarg{variable_\-name}\\\hspace{2em}(in) Name of the variable.\\[2mm]
\refarg{address}\\\hspace{2em}(in) Address where the variable is defined. This address must have been previously allocated using \hyperlink{group__memory_1ga39f7943b93aa2bb754726fc74d929426}{\reffun{hsa_\-memory_\-allocate}} in a global region that is only visible to \textit{agent}. The application cannot deallocate the buffer pointed by \textit{address} before \textit{executable} is destroyed.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\subsubsection{}
\vspace{-2.5mm}Enumeration constants added to \hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} by this extension.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}enum \{\\\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggabc6126af1d45847bc59afa0aa3216b04af82a7c74fcd917f5dfcf091daf4c7421}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-INVALID_\-SESSION_\-STATE}} = 0x4000,\\
\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggabc6126af1d45847bc59afa0aa3216b04a2dc99c94e140d48326536924c588d914}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-INVALID_\-SAMPLING_\-CONTEXT}} = 0x4001\\
\} \hypertarget{group__ext-performance-counters_1gabc6126af1d45847bc59afa0aa3216b04}{\textbf{}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
\hspace{-2em}\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-INVALID_\-SESSION_\-STATE}\\An operation was attempted on a session which is in an invalid state for that operation.\\[2mm]
\hspace{-2em}\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-INVALID_\-SAMPLING_\-CONTEXT}\\An attempt was made to sample a counter in an invalid context.
\end{longtable}

\subsubsection{hsa_\-ext_\-perf_\-counter_\-type_\-t}
\vspace{-2.5mm}Performance counter types (Ed. is this enum necessary? We could just use a bool, but what if we want to support float perf counters?)\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef enum \{\\\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggaad59775c5ed8a936f1a3da8e4ce947dca2e56de6eb27288f4280cec5518409bf7}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-TYPE_\-UINT32}} = 0,\\
\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggaad59775c5ed8a936f1a3da8e4ce947dcaef515e9a43ae1cd8ba8c5ecac806d23a}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-TYPE_\-UINT64}} = 1\\
\} \hypertarget{group__ext-performance-counters_1gaad59775c5ed8a936f1a3da8e4ce947dc}{\textbf{hsa_\-ext_\-perf_\-counter_\-type_\-t}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-TYPE_\-UINT32}\\This performance counter's value is an unsigned 32 bit integer.\\[2mm]
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-TYPE_\-UINT64}\\This performance counter's value is an unsigned 64 bit integer.
\end{longtable}
...
\subsubsection{hsa_\-ext_\-perf_\-counter_\-granularity_\-t}
\vspace{-2.5mm}Granularity of a performance counter.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef enum \{\\\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggad46e70bf4b33a318f1f5410da7f6506daaf05a5c2b32233439862f6d48d73b675}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-GRANULARITY_\-SYSTEM}} = 0,\\
\hspace{1.7em}\hypertarget{group__ext-performance-counters_1ggad46e70bf4b33a318f1f5410da7f6506daa118a0fb20607721dacf5d4a4fb9b4e3}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-GRANULARITY_\-PROCESS}} = 1\\
\} \hypertarget{group__ext-performance-counters_1gad46e70bf4b33a318f1f5410da7f6506d}{\textbf{hsa_\-ext_\-perf_\-counter_\-granularity_\-t}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-GRANULARITY_\-SYSTEM}\\This performance counter applies to the whole system.\\[2mm]
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-GRANULARITY_\-PROCESS}\\This performance counter applies to a single process.
\end{longtable}

\subsubsection{hsa_\-ext_\-perf_\-counter_\-value_\-persistence_\-t}
\vspace{-2.5mm}Persistence of a performance counter's value.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef enum \{\\\hspace{1.7em}\hypertarget{group__ext-performance-counters_1gga66f83bf3362343a346895fd17d8ba190aadf3c79f2c0a22aed7237d0306429ba2}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-PERSISTENCE_\-RESETS}} = 0,\\
\hspace{1.7em}\hypertarget{group__ext-performance-counters_1gga66f83bf3362343a346895fd17d8ba190aae5bb140d4d8cedd64cff7b1a0a8fdf7}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-PERSISTENCE_\-PERSISTS}} = 1\\
\} \hypertarget{group__ext-performance-counters_1ga66f83bf3362343a346895fd17d8ba190}{\textbf{hsa_\-ext_\-perf_\-counter_\-value_\-persistence_\-t}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-PERSISTENCE_\-RESETS}\\This performance counter resets when a session begins.\\[2mm]
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-PERSISTENCE_\-PERSISTS}\\This performance counter does not reset when a session begins.
\end{longtable}

\subsubsection{hsa_\-ext_\-perf_\-counter_\-value_\-type_\-t}
\vspace{-2.5mm}The type of value which the performance counter exposes.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef enum \{\\\hspace{1.7em}\hypertarget{group__ext-performance-counters_1gga4e9737cba268461db289b9812bdeaeffad1d714633c4cb3d1a8ed0b29c09c5963}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-TYPE_\-GENERIC}} = 0,\\
\hspace{1.7em}\hypertarget{group__ext-performance-counters_1gga4e9737cba268461db289b9812bdeaeffa42c2e82215474984f50540c1e7583892}{\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-TYPE_\-PERCENTAGE}} = 1\\
\} \hypertarget{group__ext-performance-counters_1ga4e9737cba268461db289b9812bdeaeff}{\textbf{hsa_\-ext_\-perf_\-counter_\-value_\-type_\-t}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-TYPE_\-GENERIC}\\The value is a generic integer (e.g. a counter or a value explained by the performance counter description).\\[2mm]
\hspace{-2em}\refenu{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-TYPE_\-PERCENTAGE}\\The value is a percentage
\end{longtable}
...
\subsubsection{hsa_\-ext_\-prof_\-session_\-ctx_\-t}
\vspace{-2.5mm}An opaque handle to a profiling session context, which is used to represent a set of enabled performance counters.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef struct  hsa_ext_prof_session_ctx_s \{\\
\hspace{1.7em}uint64_\-t \reffld{handle};\\
\}  \hypertarget{group__ext-performance-counters_1ga04c85f0185ec5d193d5d699b39f2b2f9}{\textbf{hsa_\-ext_\-prof_\-session_\-ctx_\-t}}\rule[-2ex]{0pt}{0pt}
\end{mylongtable}

\noindent\textbf{Data Fields}\\[-7mm]
\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\hypertarget{hsa_\-ext_\-prof_\-session_\-ctx_\-t.handle}{\reffld{handle}}\\\hspace{2em}Opaque handle.
\end{longtable}



\index[ext]{hsa_ext_get_num_perf_counters}\subsubsection{hsa_\-ext_\-get_\-num_\-perf_\-counters}
\vspace{-2.5mm}Get the number of counters available in the entire system.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\textbf{hsa_\-ext_\-get_\-num_\-perf_\-counters}}(\\\hspace*{1.7em}uint32_\-t *\refarg{result});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{result}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the query.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_perf_counter_info}\subsubsection{hsa_\-ext_\-get_\-perf_\-counter_\-info}
\vspace{-2.5mm}Get the current value of an attribute of a profiling counter.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga287f1ddeb59d62dc217c0a2cd837c199}{\textbf{hsa_\-ext_\-get_\-perf_\-counter_\-info}}(\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx},\\\hspace*{1.7em}\hyperlink{group__ext-performance-counters_1ga71d623b4fdc55109b71c12f1ccd04e5a}{hsa_\-ext_\-perf_\-counter_\-info_\-t} \refarg{attribute},\\\hspace*{1.7em}void *\refarg{value});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive).\\[2mm]
\refarg{attribute}\\\hspace{2em}(in) Attribute to query.\\[2mm]
\refarg{value}\\\hspace{2em}(out) Pointer to an application-allocated buffer where to store the value of the attribute. If the buffer passed by the application is not large enough to hold the value of the attribute, the behavior is undefined.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_create_session_context}\subsubsection{hsa_\-ext_\-create_\-session_\-context}
\vspace{-2.5mm}Create a session context. This should be destroyed with a call to \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}}.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\textbf{hsa_\-ext_\-create_\-session_\-context}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx *\refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(out) Memory location where the HSA runtime stores the newly created session context handle.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225a34ea59ade5bfce95eee935238a99f5b5}{HSA_\-STATUS_\-ERROR_\-NOT_\-INITIALIZED}\\\hspace{2em}The HSA runtime has not been initialized.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225a1a77fcf36d0d140874c4361ab093eff7}{HSA_\-STATUS_\-ERROR_\-OUT_\-OF_\-RESOURCES}\\\hspace{2em}There is a failure to allocate resources required for the operation.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ac7d3651f75107d2a6a8ba3b25683c030}{HSA_\-STATUS_\-ERROR_\-INVALID_\-ARGUMENT}\\\hspace{2em}\textit{ctx} is NULL.
\end{longtable}
\vspace{-2mm} 


\index[ext]{hsa_ext_destroy_session_context}\subsubsection{hsa_\-ext_\-destroy_\-session_\-context}
\vspace{-2.5mm}Destroy a session context.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\textbf{hsa_\-ext_\-destroy_\-session_\-context}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has already been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_enable_perf_counter}\subsubsection{hsa_\-ext_\-enable_\-perf_\-counter}
\vspace{-2.5mm}Enable sampling for the performance counter at the given index. Calls to \hyperlink{group__ext-performance-counters_1ga8712d7cd3d07e6a71423563b5c0672d9}{\reffun{hsa_\-ext_\-start_\-profile_\-session}} between this call and a corresponding successful \hyperlink{group__ext-performance-counters_1ga916ea63f52fb2658e4751730a612ab1c}{\reffun{hsa_\-ext_\-disable_\-perf_\-counter}} call will cause this performance counter to be populated.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga18e49a17a82528c8eabf74c2c0a9557b}{\textbf{hsa_\-ext_\-enable_\-perf_\-counter}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive). If the specified counter is already enabled, this function has no effect.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_disable_perf_counter}\subsubsection{hsa_\-ext_\-disable_\-perf_\-counter}
\vspace{-2.5mm}Disable sampling for the performance counter at the given index. Calls to \hyperlink{group__ext-performance-counters_1ga8712d7cd3d07e6a71423563b5c0672d9}{\reffun{hsa_\-ext_\-start_\-profile_\-session}} will no longer populate this performance counter until the corresponding call to \hyperlink{group__ext-performance-counters_1ga18e49a17a82528c8eabf74c2c0a9557b}{\reffun{hsa_\-ext_\-enable_\-perf_\-counter}} is succesfully executed.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga916ea63f52fb2658e4751730a612ab1c}{\textbf{hsa_\-ext_\-disable_\-perf_\-counter}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive). If the specified counter is already disabled, this function has no effect.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_perf_counter_enabled}\subsubsection{hsa_\-ext_\-perf_\-counter_\-enabled}
\vspace{-2.5mm}Check if the performance counter at the given index is currently enabled.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga753be35fb9a820e28cfef1232a1f080e}{\textbf{hsa_\-ext_\-perf_\-counter_\-enabled}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx},\\\hspace*{1.7em}bool *\refarg{enabled});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive).\\[2mm]
\refarg{enabled}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the check. The result is true if the performance counter at the given index is currently enabled and false otherwise.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_prof_session_counter_set_valid}\subsubsection{hsa_\-ext_\-prof_\-session_\-counter_\-set_\-valid}
\vspace{-2.5mm}Check if the set of currently enabled performance counters in a given session context can be sampled in a single profiling session. This call does not enable or disable any performance counters; the client is responsible for discovering a valid set.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga500ae23357f8695ed6ba56e8036177a4}{\textbf{hsa_\-ext_\-prof_\-session_\-counter_\-set_\-valid}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}bool *\refarg{result});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{result}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the check. The result is true if the enabled performance counter set can be sampled in a single profiling session and false otherwise. If there are no profiling counters enabled, the result is true.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_prof_session_set_valid}\subsubsection{hsa_\-ext_\-prof_\-session_\-set_\-valid}
\vspace{-2.5mm}Check if the set of currently enabled performance counters in a given session context can be sampled in a single profiling session. This call does not enable or disable any performance counters; the client is responsible for discovering a valid set.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1gafe326c88d4e30bfbc5172047c43ad0ad}{\textbf{hsa_\-ext_\-prof_\-session_\-set_\-valid}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx *\refarg{ctxs},\\\hspace*{1.7em}size_\-t \refarg{n_\-ctxs},\\\hspace*{1.7em}bool *\refarg{result});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctxs}\\\hspace{2em}(in) Pointer to an array of :hsa_\-ext_\-prof_\-session_\-ctx objects of size \textit{n_\-ctxs}\\[2mm]
\refarg{n_\-ctxs}\\\hspace{2em}(in) The size of the \textit{ctxs} array.\\[2mm]
\refarg{result}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the check. The result is true if the sessions can be executed concurrently and false otherwise.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_enable_profile_session}\subsubsection{hsa_\-ext_\-enable_\-profile_\-session}
\vspace{-2.5mm}Enable a profiling session. Performance counters enabled through calls to \hyperlink{group__ext-performance-counters_1ga18e49a17a82528c8eabf74c2c0a9557b}{\reffun{hsa_\-ext_\-enable_\-perf_\-counter}} without an intervening call to \hyperlink{group__ext-performance-counters_1ga916ea63f52fb2658e4751730a612ab1c}{\reffun{hsa_\-ext_\-disable_\-perf_\-counter}} for the same counter index will be readied for counting and sampling. Performance counters which have the attribute \hyperlink{group__ext-performance-counters_1gga66f83bf3362343a346895fd17d8ba190aadf3c79f2c0a22aed7237d0306429ba2}{HSA_\-EXT_\-PERF_\-COUNTER_\-VALUE_\-PERSISTENCE_\-RESETS} for \hyperlink{group__ext-performance-counters_1gga71d623b4fdc55109b71c12f1ccd04e5aa9ab18c7c0722fad485e6a3b9f786fdaa}{HSA_\-EXT_\-PERF_\-COUNTER_\-INFO_\-VALUE_\-PERSISTENCE} will reset to 0.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga04c9f535db8ece9879cbfa3581b405f3}{\textbf{hsa_\-ext_\-enable_\-profile_\-session}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_disable_profile_session}\subsubsection{hsa_\-ext_\-disable_\-profile_\-session}
\vspace{-2.5mm}Disable a profiling session. Reading performance counters for that session is no longer valid.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1gaedbfd6ac01ad4388f012f5540e269b5a}{\textbf{hsa_\-ext_\-disable_\-profile_\-session}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.
\end{longtable}
...
\index[ext]{hsa_ext_start_profile_session}\subsubsection{hsa_\-ext_\-start_\-profile_\-session}
\vspace{-2.5mm}Start a profiling session. Performance counters enabled through calls to \hyperlink{group__ext-performance-counters_1ga18e49a17a82528c8eabf74c2c0a9557b}{\reffun{hsa_\-ext_\-enable_\-perf_\-counter}} without an intervening call to \hyperlink{group__ext-performance-counters_1ga916ea63f52fb2658e4751730a612ab1c}{\reffun{hsa_\-ext_\-disable_\-perf_\-counter}} for the same counter index will count until a successful call to ::hsa_stop_profiling_session with the same session context.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga8712d7cd3d07e6a71423563b5c0672d9}{\textbf{hsa_\-ext_\-start_\-profile_\-session}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.
\end{longtable}
...
\index[ext]{hsa_ext_stop_profile_session}\subsubsection{hsa_\-ext_\-stop_\-profile_\-session}
\vspace{-2.5mm}Stop a profiling session, freezing the counters which were enabled. Reading of performance counters which do not support in-session reading is now valid until a call to \hyperlink{group__ext-performance-counters_1gaedbfd6ac01ad4388f012f5540e269b5a}{\reffun{hsa_\-ext_\-disable_\-profile_\-session}} with the same session context. If the session is already stopped, this function has no effect. The session can be started again with a call to \hyperlink{group__ext-performance-counters_1ga8712d7cd3d07e6a71423563b5c0672d9}{\reffun{hsa_\-ext_\-start_\-profile_\-session}}; the state of the counters will be carried over from the point at which this function was called.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga84589a9c9d41117a3383d372614c28e0}{\textbf{hsa_\-ext_\-stop_\-profile_\-session}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.
\end{longtable}
...
\index[ext]{hsa_ext_read_perf_counter_uint32}\subsubsection{hsa_\-ext_\-read_\-perf_\-counter_\-uint32}
\vspace{-2.5mm}Read the value of a given performance counter as a uint32_\-t. The value type of a performance counter can be queried using hsa_\-ext_\-get_\-perf_\-counter_\-info.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1gad768882737253a094641d18953943a8d}{\textbf{hsa_\-ext_\-read_\-perf_\-counter_\-uint32}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx},\\\hspace*{1.7em}uint32_\-t *\refarg{result});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive).\\[2mm]
\refarg{result}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the check.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_read_perf_counter_uint64}\subsubsection{hsa_\-ext_\-read_\-perf_\-counter_\-uint64}
\vspace{-2.5mm}Read the value of a given performance counter as a uint64_\-t. The value type of a performance counter can be queried using hsa_\-ext_\-get_\-perf_\-counter_\-info.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-performance-counters_1ga28355445fa84a8a054853fc5bb407019}{\textbf{hsa_\-ext_\-read_\-perf_\-counter_\-uint64}}(\\\hspace*{1.7em}hsa_\-ext_\-prof_\-session_\-ctx \refarg{ctx},\\\hspace*{1.7em}uint32_\-t \refarg{counter_\-idx},\\\hspace*{1.7em}uint64_\-t *\refarg{result});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{ctx}\\\hspace{2em}(in) Session context. Using an object which has not been created using \hyperlink{group__ext-performance-counters_1ga3519641afa5a9f65ce3d153515d29b08}{\reffun{hsa_\-ext_\-create_\-session_\-context}} or has been destroyed with \hyperlink{group__ext-performance-counters_1ga7619b1d4affde950e1207c8fe7a0e3b4}{\reffun{hsa_\-ext_\-destroy_\-session_\-context}} is undefined behaviour.\\[2mm]
\refarg{counter_\-idx}\\\hspace{2em}(in) Performance counter index. Must have a value between 0 (inclusive) and the value returned by \hyperlink{group__ext-performance-counters_1gaa1fd852bc172a07a77005876b357e72d}{\reffun{hsa_\-ext_\-get_\-num_\-perf_\-counters}} (not inclusive).\\[2mm]
...
\subsubsection{}
\vspace{-2.5mm}Enumeration constants added to \hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} by this extension.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}enum \{\\\hspace{1.7em}\hypertarget{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06ca84eb860b4812a9cd94affc3f60750347}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-EVENTS_\-NOT_\-ENABLED}} = 0x5000,\\
\hspace{1.7em}\hypertarget{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06cae1c2e9ff2d0ccc1ee78413e5a8b88139}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-ALREADY_\-INITIALIZED}} = 0x5001,\\
\hspace{1.7em}\hypertarget{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06cae57f0700419e4fec14ff54d61dcc51bf}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-OUT_\-OF_\-EVENTS}} = 0x5002,\\
\hspace{1.7em}\hypertarget{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06cad8f0d6cb5dbfc9eddf0f7de3da5c642a}{\refenu{HSA_\-EXT_\-STATUS_\-ERROR_\-EVENT_\-NOT_\-REGISTERED}} = 0x5003\\
\} \hypertarget{group__ext-event-system_1gadc29c2ff13d900c2f185ee95427fb06c}{\textbf{}};\rule[-2ex]{0pt}{0pt}\end{mylongtable}\noindent\textbf{Values}\\[-7mm]
\begin{longtable}{@{\hspace{2em}}p{\linewidth-2em}}
...
\subsubsection{hsa_\-ext_\-timeline_\-event_\-t}
\vspace{-2.5mm}\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef struct  hsa_ext_timeline_event_s \{\\
\hspace{1.7em}uint64_\-t \reffld{handle};\\
\}  \hypertarget{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{\textbf{hsa_\-ext_\-timeline_\-event_\-t}}\rule[-2ex]{0pt}{0pt}
\end{mylongtable}

\noindent\textbf{Data Fields}\\[-7mm]
\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\hypertarget{hsa_\-ext_\-timeline_\-event_\-t.handle}{\reffld{handle}}\\\hspace{2em}Opaque handle.
\end{longtable}
...
\subsubsection{hsa_\-ext_\-event_\-metadata_\-t}
\vspace{-2.5mm}An event metadata entry.\begin{mylongtable}{@{}p{\textwidth}}
\rule{0pt}{3ex}typedef struct  hsa_ext_event_metadata \{\\
\hspace{1.7em}const char * \reffld{data_\-name};\\
\hspace{1.7em}size_\-t \reffld{name_\-length};\\
\hspace{1.7em}void * \reffld{data};\\
\hspace{1.7em}size_\-t \reffld{data_\-size};\\
\hspace{1.7em}hsa_\-ext_\-event_\-metadata_\-type_\-t \reffld{metadata_\-type};\\
\}  \hypertarget{group__ext-event-system_1ga2f9f37c504e67d4030d199bb41d1f128}{\textbf{hsa_\-ext_\-event_\-metadata_\-t}}\rule[-2ex]{0pt}{0pt}
\end{mylongtable}
...
\index[ext]{hsa_ext_init_with_timeline_events}\subsubsection{hsa_\-ext_\-init_\-with_\-timeline_\-events}
\vspace{-2.5mm}Initialize the HSA runtime with the timeline events system available for enabling for a given set of event producer types.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gac544795581d7e0f66a7f51c528a43351}{\textbf{hsa_\-ext_\-init_\-with_\-timeline_\-events}}(\\\hspace*{1.7em}uint32_\-t \refarg{producer_\-mask});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{producer_\-mask}\\\hspace{2em}(in) Mask of event producers to enable for timeline event collection. This is a bit-field of \hyperlink{group__ext-event-system_1ga56de005222a9d59668abf380a190c8e7}{hsa_\-ext_\-event_\-producer_\-t} values. Any unknown set bits are ignored.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225a1a77fcf36d0d140874c4361ab093eff7}{HSA_\-STATUS_\-ERROR_\-OUT_\-OF_\-RESOURCES}\\\hspace{2em}There is failure to allocate the resources required by the implementation.\\[2mm]
\hyperlink{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06cae1c2e9ff2d0ccc1ee78413e5a8b88139}{HSA_\-EXT_\-STATUS_\-ERROR_\-ALREADY_\-INITIALIZED}\\\hspace{2em}The HSA runtime has already been initialized through a call to \hyperlink{group__initshutdown_1ga5b8574433e7dbcbd31ea397a02e3c32b}{\reffun{hsa_\-init}} or \hyperlink{group__ext-event-system_1gac544795581d7e0f66a7f51c528a43351}{\reffun{hsa_\-ext_\-init_\-with_\-timeline_\-events}}
\end{longtable}
\vspace{-2mm}\noindent\textbf{Description}\\
Has the same effects as \hyperlink{group__initshutdown_1ga5b8574433e7dbcbd31ea397a02e3c32b}{\reffun{hsa_\-init}} in addition to the enabling of the timeline events system. 


\index[ext]{hsa_ext_set_producer_mask}\subsubsection{hsa_\-ext_\-set_\-producer_\-mask}
\vspace{-2.5mm}Set a new producer type mask for coarse-grained filtering of events.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga49e9a70917ad8f7434c897039afa7b16}{\textbf{hsa_\-ext_\-set_\-producer_\-mask}}(\\\hspace*{1.7em}uint32_\-t \refarg{producer_\-mask});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{producer_\-mask}\\\hspace{2em}(in) Mask of event producers to enable for timeline event collection. This is a bit-field of \hyperlink{group__ext-event-system_1ga56de005222a9d59668abf380a190c8e7}{hsa_\-ext_\-event_\-producer_\-t} values.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_register_application_event_producer}\subsubsection{hsa_\-ext_\-register_\-application_\-event_\-producer}
\vspace{-2.5mm}Register a new application event producer with a given name and description.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga731cf4205bef1c9c09598cb81bc1481b}{\textbf{hsa_\-ext_\-register_\-application_\-event_\-producer}}(\\\hspace*{1.7em}const char *\refarg{name},\\\hspace*{1.7em}const char *\refarg{description},\\\hspace*{1.7em}uint32_\-t *\refarg{event_\-producer_\-id});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{name}\\\hspace{2em}(in) A NUL-terminated string containing the name. Cannot be NULL. Does not need to be unique.\\[2mm]
\refarg{description}\\\hspace{2em}(in) A NUL-terminated string containing the description. Can be NULL.\\[2mm]
\refarg{producer_\-id}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the unique identifier for this event producer.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_num_application_event_producers}\subsubsection{hsa_\-ext_\-get_\-num_\-application_\-event_\-producers}
\vspace{-2.5mm}Get the number of application event producers registered by \hyperlink{group__ext-event-system_1ga731cf4205bef1c9c09598cb81bc1481b}{\reffun{hsa_\-ext_\-register_\-application_\-event_\-producer}}.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga399c983c64451344de1f8c5cf583e293}{\textbf{hsa_\-ext_\-get_\-num_\-application_\-event_\-producers}}(\\\hspace*{1.7em}size_\-t *\refarg{n});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{n}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the result of the check.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225a34ea59ade5bfce95eee935238a99f5b5}{HSA_\-STATUS_\-ERROR_\-NOT_\-INITIALIZED}\\\hspace{2em}The HSA runtime has not been initialized.\\[2mm]
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ac7d3651f75107d2a6a8ba3b25683c030}{HSA_\-STATUS_\-ERROR_\-INVALID_\-ARGUMENT}\\\hspace{2em}\textit{n} is NULL.\\[2mm]
\hyperlink{group__ext-event-system_1ggadc29c2ff13d900c2f185ee95427fb06ca84eb860b4812a9cd94affc3f60750347}{HSA_\-EXT_\-STATUS_\-ERROR_\-EVENTS_\-NOT_\-ENABLED}\\\hspace{2em}The HSA runtime was not initialized with the \hyperlink{group__ext-event-system_1gac544795581d7e0f66a7f51c528a43351}{\reffun{hsa_\-ext_\-init_\-with_\-timeline_\-events}} function.
\end{longtable}
\vspace{-2mm} 


\index[ext]{hsa_ext_get_application_event_producer_name}\subsubsection{hsa_\-ext_\-get_\-application_\-event_\-producer_\-name}
\vspace{-2.5mm}Get the name of an application event producer from its identifier. An identifier can be retrieved from an event through \hyperlink{group__ext-event-system_1ga2eaab4fb710bd650bb76a32fdd1ed6ac}{\reffun{hsa_\-ext_\-get_\-application_\-event_\-producer_\-id}}. Arbitrary identifiers can be tested below the bound given by \hyperlink{group__ext-event-system_1ga399c983c64451344de1f8c5cf583e293}{\reffun{hsa_\-ext_\-get_\-num_\-application_\-event_\-producers}}.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga883afad07d536493b509f66859b27ff0}{\textbf{hsa_\-ext_\-get_\-application_\-event_\-producer_\-name}}(\\\hspace*{1.7em}uint32_\-t \refarg{event_\-producer_\-id},\\\hspace*{1.7em}const char **\refarg{name});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event_\-producer_\-id}\\\hspace{2em}(in) Event producer identifier.\\[2mm]
\refarg{name}\\\hspace{2em}(out) A NUL-terminated string containing the event producer name.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_application_event_producer_description}\subsubsection{hsa_\-ext_\-get_\-application_\-event_\-producer_\-description}
\vspace{-2.5mm}Get the description of an application event producer from its identifier. An identifier can be retrieved from an event through \hyperlink{group__ext-event-system_1ga2eaab4fb710bd650bb76a32fdd1ed6ac}{\reffun{hsa_\-ext_\-get_\-application_\-event_\-producer_\-id}}. Arbitrary identifiers can be tested below the bound given by \hyperlink{group__ext-event-system_1ga399c983c64451344de1f8c5cf583e293}{\reffun{hsa_\-ext_\-get_\-num_\-application_\-event_\-producers}}.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga6162f7a6ab2b85e87cff88748cf95cee}{\textbf{hsa_\-ext_\-get_\-application_\-event_\-producer_\-description}}(\\\hspace*{1.7em}uint32_\-t \refarg{event_\-producer_\-id},\\\hspace*{1.7em}const char **\refarg{description});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event_\-producer_\-id}\\\hspace{2em}(in) Event producer identifier.\\[2mm]
\refarg{description}\\\hspace{2em}(out) A NUL-terminated string containing the event producer description.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_enable_application_event_producer}\subsubsection{hsa_\-ext_\-enable_\-application_\-event_\-producer}
\vspace{-2.5mm}Enable event collection from the application event producer with the given identifier.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gabd9aca33ef800cb0248cc605fd1246b1}{\textbf{hsa_\-ext_\-enable_\-application_\-event_\-producer}}(\\\hspace*{1.7em}uint32_\-t \refarg{event_\-producer_\-id});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event_\-producer_\-id}\\\hspace{2em}(in) Event producer identifier.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_enable_agent_events}\subsubsection{hsa_\-ext_\-enable_\-agent_\-events}
\vspace{-2.5mm}Enable given agent node for collecting events.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga2febedb8176aa0d14ea86ba2b2ad68eb}{\textbf{hsa_\-ext_\-enable_\-agent_\-events}}(\\\hspace*{1.7em}\hyperlink{group__agentinfo_1gab8db3fb886332a24acac08ec361e1d86}{hsa_\-agent_\-t} \refarg{agent});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{agent}\\\hspace{2em}(in) Agent.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_enable_io_events}\subsubsection{hsa_\-ext_\-enable_\-io_\-events}
\vspace{-2.5mm}Enable given io node for collecting events.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga303c50122046c802e0362147da173bab}{\textbf{hsa_\-ext_\-enable_\-io_\-events}}(\\\hspace*{1.7em}hsa_\-io_\-t \refarg{io});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{io}\\\hspace{2em}(in) IO node. (Ed. doesn't exist yet)
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_set_event_buffer_size_hint}\subsubsection{hsa_\-ext_\-set_\-event_\-buffer_\-size_\-hint}
\vspace{-2.5mm}Provide a hint to the runtime for how many bytes to reserve for buffering events.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]*\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga9306cbac2c9ce032320d4d2cafe6b358}{\textbf{hsa_\-ext_\-set_\-event_\-buffer_\-size_\-hint}}(\\\hspace*{1.7em}size_\-t \refarg{size_\-hint});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{size_\-hint}\\\hspace{2em}(in) Suggested number of bytes to reserve for events.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_register_timeline_event}\subsubsection{hsa_\-ext_\-register_\-timeline_\-event}
\vspace{-2.5mm}Create a new timeline event.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gaad64a140d365b1068e1dc6b0ef096b47}{\textbf{hsa_\-ext_\-register_\-timeline_\-event}}(\\\hspace*{1.7em}uint32_\-t \refarg{event_\-producer_\-id},\\\hspace*{1.7em}const char *\refarg{name},\\\hspace*{1.7em}uint64_\-t *\refarg{event_\-id});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event_\-producer_\-id}\\\hspace{2em}(in) Event producer identifier.\\[2mm]
\refarg{name}\\\hspace{2em}(in) A NUL-terminated string containing the name. Can be NULL.\\[2mm]
\refarg{event_\-id}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores a producer-specific event identifier.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_trigger_timeline_event}\subsubsection{hsa_\-ext_\-trigger_\-timeline_\-event}
\vspace{-2.5mm}Trigger a timeline event with an ID, name and any associated metadata.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga7a1bb201157288c51c538caeaf1383ce}{\textbf{hsa_\-ext_\-trigger_\-timeline_\-event}}(\\\hspace*{1.7em}uint64_\-t \refarg{event_\-id},\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga2f9f37c504e67d4030d199bb41d1f128}{hsa_\-ext_\-event_\-metadata_\-t} *\refarg{metadata_\-array},\\\hspace*{1.7em}size_\-t \refarg{n_\-metadata});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event_\-id}\\\hspace{2em}(in) Producer-specific event identifier.\\[2mm]
\refarg{metadata}\\\hspace{2em}(in) A pointer to an array of metadata entries. Can be NULL.\\[2mm]
\refarg{metadata_\-size}\\\hspace{2em}(in) The number of metadata entries in \textit{metadata_\-array}. If \textit{metadata_\-array} is NULL, this should be 0.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_next_event}\subsubsection{hsa_\-ext_\-get_\-next_\-event}
\vspace{-2.5mm}Retrieve the next event from an event buffer.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga5325d3098676c5d3dc21af979475d726}{\textbf{hsa_\-ext_\-get_\-next_\-event}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} *\refarg{event});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the event.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_destroy_event}\subsubsection{hsa_\-ext_\-destroy_\-event}
\vspace{-2.5mm}Destroy an event.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga32f4f0ecc09354ad6a4d0b4d0c46367e}{\textbf{hsa_\-ext_\-destroy_\-event}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(out) Event.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_timeline_event_timestamp}\subsubsection{hsa_\-ext_\-get_\-timeline_\-event_\-timestamp}
\vspace{-2.5mm}Get the \hyperlink{group__agentinfo_1gga5358716e320ad8a78b78ef44d8783b0bac9043678e4c1dd887fcf71cabee228f6}{HSA_\-SYSTEM_\-INFO_\-TIMESTAMP} for when the event was triggered.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gac71dcadce870c3934e9214c351590a56}{\textbf{hsa_\-ext_\-get_\-timeline_\-event_\-timestamp}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}uint64_\-t *\refarg{timestamp});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{timestamp}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the timestamp.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_timeline_event_producer_type}\subsubsection{hsa_\-ext_\-get_\-timeline_\-event_\-producer_\-type}
\vspace{-2.5mm}Get the \hyperlink{group__agentinfo_1gga5358716e320ad8a78b78ef44d8783b0bac9043678e4c1dd887fcf71cabee228f6}{HSA_\-SYSTEM_\-INFO_\-TIMESTAMP} for when the event was triggered.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gaea29973f9841617336fadf202a41388d}{\textbf{hsa_\-ext_\-get_\-timeline_\-event_\-producer_\-type}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga56de005222a9d59668abf380a190c8e7}{hsa_\-ext_\-event_\-producer_\-t} *\refarg{producer_\-type});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{producer_\-type}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the producer type.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_application_event_producer_id}\subsubsection{hsa_\-ext_\-get_\-application_\-event_\-producer_\-id}
\vspace{-2.5mm}Get the unique event producer identifier for a given application event.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga2eaab4fb710bd650bb76a32fdd1ed6ac}{\textbf{hsa_\-ext_\-get_\-application_\-event_\-producer_\-id}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}uint64_\-t *\refarg{event_\-producer_\-id});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{producer_\-type}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the producer type.
...
\index[ext]{hsa_ext_get_timeline_event_id}\subsubsection{hsa_\-ext_\-get_\-timeline_\-event_\-id}
\vspace{-2.5mm}Get the id of an event.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga6842939757fa6a50fb7384af4c134bd3}{\textbf{hsa_\-ext_\-get_\-timeline_\-event_\-id}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}uint64_\-t *\refarg{id});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{id}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores the id.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_timeline_event_name}\subsubsection{hsa_\-ext_\-get_\-timeline_\-event_\-name}
\vspace{-2.5mm}Get the name of an event.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1gac024ced5007e1ca1d508d5ce14b7705e}{\textbf{hsa_\-ext_\-get_\-timeline_\-event_\-name}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}char **\refarg{name});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{name}\\\hspace{2em}(out) A NUL-terminated string containing the event string data. If there is no associated string data, the result is NULL.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
...
\index[ext]{hsa_ext_get_timeline_event_metadata}\subsubsection{hsa_\-ext_\-get_\-timeline_\-event_\-metadata}
\vspace{-2.5mm}Get event metadata.\begin{mylongtable}{@{}p{\textwidth}}

\pbox{\textwidth}{\hspace{1mm}\\[1mm]\hyperlink{group__status_1gad755322e7ff95456520e8abdbe90d225}{hsa_\-status_\-t} \hypertarget{group__ext-event-system_1ga9807178064d3f6025af781621b51201e}{\textbf{hsa_\-ext_\-get_\-timeline_\-event_\-metadata}}(\\\hspace*{1.7em}\hyperlink{group__ext-event-system_1ga3f7ff154bb28f0f12178244b908fdbf7}{hsa_\-ext_\-timeline_\-event_\-t} \refarg{event},\\\hspace*{1.7em}hsa_\-ext_\-metadata_\-t **\refarg{metadata_\-list},\\\hspace*{1.7em}size_\-t *\refarg{n});\\}\end{mylongtable}
\vspace{-3.5mm}\hspace*{-.3mm}\textbf{Parameters}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\textwidth}}
\refarg{event}\\\hspace{2em}(in) Event.\\[2mm]
\refarg{metadata_\-list}\\\hspace{2em}(out) Pointer to a memory location where the HSA runtime stores a pointer to an array of metadata entries.\\[2mm]
\refarg{n}\\\hspace{2em}(out) The number of metadata entries in the list.
\end{longtable}
\vspace{-2mm}\textbf{Return Values}\\[-7mm]
\noindent\begin{longtable}{@{}>{\hangindent=2em}p{\linewidth}}
\hyperlink{group__status_1ggad755322e7ff95456520e8abdbe90d225ae382ea0c9c05cce5a60d0317375159cc}{HSA_\-STATUS_\-SUCCESS}\\\hspace{2em}The function has been executed successfully.\\[2mm]
