...
\DIFdelbegin \DIFdel{This is }%DIFDELCMD < {\color{red} %%%
\DIFdel{work-in-progress}%DIFDELCMD < } %%%
\DIFdel{-- the chapter needs to be written.
 }\DIFdelend \DIFaddbegin \lstinputlisting{asyncerror.c}
