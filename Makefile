...
main-diff.tex: main-all.tex main-all-prev.tex
	latexdiff -t UNDERLINE --append-safecmd="hsaarg,diffblock" --exclude-textcmd="emph,subsection,ttbf" --config="PICTUREENV=(?:picture|DIFnomarkup|lstlisting|tikzpicture|figure)[\w\d*@]*" main-all-prev.tex main-all.tex > main-diff.tex
